...
// 本地工作区状态管理。应用不需要登录，所有数据只保存在当前浏览器。
...
function performLoginCheck() {
    currentUser = {
        ...
        username: '本机工作区',
        role: 'local',
        permissions: [...LOCAL_WORKSPACE_PERMISSIONS]
    };
    isLoggedIn = true;
    window.localWorkspaceMode = true;
    ...
    /* Legacy account-session handling retained below only for data migration.
       The local workspace returns before reaching it. */
